...
from tabs import intro, exploration, preprocessing, dataviz, features_engineering, modeling, happinessmeter, conclusion, about
...
TABS = OrderedDict(
    [
        ...
        (features_engineering.sidebar_name, features_engineering),

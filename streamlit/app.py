...
from tabs import intro, exploration, preprocessing, dataviz, feautres_engineering, modeling, happinessmeter, conclusion, about
...
TABS = OrderedDict(
    [
        ...
        (feautres_engineering.sidebar_name, feautres_engineering),

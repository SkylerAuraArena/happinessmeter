...
def run():
    ...
    st.write("Le projet initial a été proposé sur le site ***Kaggle*** à l'adresse suivante : https://www.kaggle.com/datasets/ajaypalsinghlo/world-happiness-report-2021.")
    st.write("Le ***World Happiness Report*** dans ses différentes éditions est disponible à l'adresse suivante : https://worldhappiness.report/.")
    st.write("Ce projet a été réalisé dans le cadre du cursus ***Data Analyst*** de ***Datascientest***. Plus d'information à l'adresse suivante : https://datascientest.com/formation-data-analyst.")